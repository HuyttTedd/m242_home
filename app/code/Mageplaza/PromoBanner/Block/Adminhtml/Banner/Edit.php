...
class Edit extends Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Mageplaza_PromoBanner';
    ...
    {
        $banner = $this->coreRegistry->registry('mppromobanner_banner');
        if ($banner->getId()) {
            return __("Edit Promo Banner '%1'", $this->escapeHtml($banner->getName()));
        }

        return __('New Promo Banner');
    }
